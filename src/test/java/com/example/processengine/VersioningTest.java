...
import com.example.processengine.demo.CustomerNotificationProcessDefinitions;
...
class VersioningTest {
    ...
    void instancesStartedBeforeANewVersionDeploysStayPinnedToTheirOriginalVersion() {
        ...
        // v2's sendConfirmationEmail step is a SUB_PROCESS calling "customer-notification" (see
        // DemoProcessDefinitions#v2) -- unlike DemoDataLoader's own startup seeding (disabled in
        // this profile, see application-test.yml), this test deploys it directly since it starts
        // a real v2 instance and awaits it all the way to COMPLETED.
        engine.deploy(CustomerNotificationProcessDefinitions.PROCESS_KEY, CustomerNotificationProcessDefinitions.v1());
