...
class PauseSwitchTest {
    ...
    void doesNothingWhenTheSlowSwitchIsFalse() throws InterruptedException {
        var ctx =
                new StepExecutionContext(UUID.randomUUID(), "chargePayment", 1, Map.of("chargePaymentSlow", false));
    ...
    void pausesLongEnoughToBeInterruptedWhenTheSlowSwitchIsSet() throws InterruptedException {
        var ctx =
                new StepExecutionContext(UUID.randomUUID(), "chargePayment", 1, Map.of("chargePaymentSlow", true));
    ...
    void onlyThatStepsOwnSlowVariableTriggersThePause() throws InterruptedException {
        var ctx =
                new StepExecutionContext(UUID.randomUUID(), "chargePayment", 1, Map.of("reserveInventorySlow", true));
