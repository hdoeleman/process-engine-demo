...
// form gate behind "New order", since those are the two elements specific to actually composing a
// new one. Matches the admin console's own "New instance" gate (see admin.js).
